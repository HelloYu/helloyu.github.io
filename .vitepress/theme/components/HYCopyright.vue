  ...
  <div class="copyright">
    <div class="content">
      <div class="item">
        ...
        <span>文章作者：</span>
        <span>
          <a href="http://helloyu.top" title="进入作者主页" target="_blank">HelloYu</a>
        </span>
      </div>
      <div class="item">
        <svg class="icon" width="20" height="20" viewBox="0 0 1024 1024">
      ...
      <div class="item">
        ...
        <span>版权申明：如无特殊说明，本站文章均为作者原创，著作权归作者所有。商业转载请联系作者获得授权，非商业转载请注明出处，谢谢！</span>
      </div>
    </div>
  </div>
</template>
...
const articleLink = computed(() => { return frontmatter.value?.articleLink ?? decodeURI(window.location.href) })
